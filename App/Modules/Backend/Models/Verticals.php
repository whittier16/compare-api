...
class Verticals extends ModelBase {
	...
	public function initialize(){
		...
		$this->hasMany("id", 'App\Modules\Backend\Models\Channels', "verticalId",
			array(
				"foreignKey" => array(
					"action" => Relation::ACTION_CASCADE,
					"message" => "The vertical cannot be deleted because other channels are using it."
				)
			)
       	);
